...
Os dados utilizados foram obtidos do **portal de dados abertos da Prefeitura de Recife**. Este portal disponibiliza, de forma pública, dados que são gerados por secretarias e órgãos da gestão municipal. Além de dados referentes a área da saúde, o portal conta..




![Dados Recife](http://dados.recife.pe.gov.br/base/images/logo-dados-recife.png)
