...
```{r echo=FALSE}
# Jogar tabela de vacinados para exemplicar as colunas originais
vacinados2021<- read.csv("vacinados2021.csv",sep = ";",header = T)
datatable(vacinados2021[1:3,])
...
#Printando datatable
datatable(vacinados2021[1:10,c(1,10)])
...
vacinados2021$sexo <- factor(vacinados2021$sexo)
vacinados2021$vacina_fabricante <- factor(vacinados2021$vacina_fabricante)
vacinados2021$grupoEtario <- unlist(vacinados2021$grupoEtario)
vacinados2021$grupoEtario <- factor(vacinados2021$grupoEtario)
