...
Diferentemente do que é visto nas primeiras doses, é visto uma diminuição exorbitante no processo de vacinação da 4ºdose, números esses que apenas tendiam a diminuir, devido ao fato de não haver mais o "medo" que a COVID troxe, contudo a implementação das doses são se suma importância, saúde deve ser tratada como prioridade.Fato da 4ºdose ter sido minima, encontrasse 2 fatores que são válidos citar. 

- Fato Nº1 -  Ela ainda estar em vigor.
